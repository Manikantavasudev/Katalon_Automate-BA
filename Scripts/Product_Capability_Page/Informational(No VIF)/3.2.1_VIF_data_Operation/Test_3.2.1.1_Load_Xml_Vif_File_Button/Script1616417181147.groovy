...
WebUI.comment('TestcaseName:: '+'Test_3.2.1.1_Load_Xml_Vif_File_Button(Informational_Mode)'+'\n')
...
WebUI.comment('********* Test_3.2.1.1_Load_Xml_Vif_File_Button  Execution Ended *********'+'\n')
