...
'To read port3_config.json values'
File port3_config_obj = new File('Five_Port_Data_Config\\port3_config.json')
Map port3_info = new JsonSlurper().parseFile(port3_config_obj, 'UTF-8')
...
def load_vif_field_config = port3_info.Load_Vif_Field
def dut_type = port3_info.Dut_Type
...
def pop_up3 = WebUI.getText(findTestObject('Object Repository/Test_Case_Selection/option_pop_up'))
println(pop_up3)
if(pop_up3 == 'Off') {
