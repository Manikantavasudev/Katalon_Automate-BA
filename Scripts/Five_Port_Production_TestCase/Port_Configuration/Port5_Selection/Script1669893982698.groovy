...
'To read port5_config.json values'
...
def load_vif_field_config = port5_info.Load_Vif_Field
def dut_type = port5_info.Dut_Type
...
def pop_up5 = WebUI.getText(findTestObject('Object Repository/Test_Case_Selection/option_pop_up'))
println(pop_up5)
if(pop_up5 == 'Off') {
