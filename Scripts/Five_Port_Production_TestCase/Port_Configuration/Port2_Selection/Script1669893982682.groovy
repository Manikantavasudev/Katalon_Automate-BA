...
'To read port2_config.json values'
...
def load_vif_field_config = port2_info.Load_Vif_Field
def dut_type = port2_info.Dut_Type
...
def pop_up2 = WebUI.getText(findTestObject('Object Repository/Test_Case_Selection/option_pop_up'))
println(pop_up2)
if(pop_up2 == 'Off') {
