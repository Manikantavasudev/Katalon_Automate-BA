...
'To read port4_config.json values'
...
def load_vif_field_config = port4_info.Load_Vif_Field
def dut_type = port4_info.Dut_Type
...
def pop_up4 = WebUI.getText(findTestObject('Object Repository/Test_Case_Selection/option_pop_up'))
println(pop_up4)
if(pop_up4 == 'Off') {
