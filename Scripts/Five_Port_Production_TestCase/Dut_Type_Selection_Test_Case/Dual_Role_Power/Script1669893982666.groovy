...
File prop_obj = new File('Test_Json/DRP_TestCase.json')
...
def Tree_Sub_Switcher_4_37 = "$Test_info.Expand_Test_List.Tree_Switcher_Start04.Tree_Sub_Switcher_4_37"
driver.findElement(By.xpath(('//span[text()=\'' + Tree_Sub_Switcher_4_37) + '\']')).click()
def Tree_Sub_Switcher_4_38 = "$Test_info.Expand_Test_List.Tree_Switcher_Start04.Tree_Sub_Switcher_4_38"
driver.findElement(By.xpath(('//span[text()=\'' + Tree_Sub_Switcher_4_38) + '\']')).click()
