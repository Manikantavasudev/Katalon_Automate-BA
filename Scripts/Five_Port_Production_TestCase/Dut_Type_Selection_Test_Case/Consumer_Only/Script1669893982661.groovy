...
File prop_obj = new File('Test_Json/Consumer_TestCase.json')
...
def Tree_Sub_Switcher_1_15 = "$Test_info.Expand_Test_List.Tree_Switcher_Start01.Tree_Sub_Switcher_1_15"
driver.findElement(By.xpath(('//span[text()=\'' + Tree_Sub_Switcher_1_15) + '\']')).click()
...
def Tree_Sub_Switcher_4_11 = "$Test_info.Expand_Test_List.Tree_Switcher_Start04.Tree_Sub_Switcher_4_11"
driver.findElement(By.xpath(('//span[text()=\'' + Tree_Sub_Switcher_4_11) + '\']')).click()
def Tree_Sub_Switcher_4_12 = "$Test_info.Expand_Test_List.Tree_Switcher_Start04.Tree_Sub_Switcher_4_12"
driver.findElement(By.xpath(('//span[text()=\'' + Tree_Sub_Switcher_4_12) + '\']')).click()
