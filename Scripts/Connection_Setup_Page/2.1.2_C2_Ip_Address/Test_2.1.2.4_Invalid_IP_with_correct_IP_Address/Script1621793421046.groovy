...
'STEP 3&4: To Verify Tester Details status and ip address with red icon displayed in dropdown'

CustomKeywords.'grl_usb_pd_c2_Testcase.ConnectionSetup_Page.getInvalidIpWithCorrectIpStatus'()
