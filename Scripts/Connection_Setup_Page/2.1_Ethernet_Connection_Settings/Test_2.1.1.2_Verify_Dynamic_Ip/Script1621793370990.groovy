...
String cs_c2_dynamic_ip_address = all_data.user_config_data.CS_C2_Dynamic_IP_Address

'STEP 2 : To click Scan Network button'
WebUI.click(findTestObject('Connection_Setup_Objects/button_Scan Network'))

WebUI.comment('This is user provided Dynamic ip' +   cs_c2_dynamic_ip_address)

'STEP 3 : To Verify the User provided Dynamic ip with dropdown pass icon list '
List pass_ip_address = CustomKeywords.'grl_usb_pd_c2_Testcase.ConnectionSetup_Page.getDropdownIpWithPassIcon'()

CustomKeywords.'grl_usb_pd_c2_Testcase.ConnectionSetup_Page.verifyDynamicIp'(pass_ip_address, cs_c2_dynamic_ip_address)
