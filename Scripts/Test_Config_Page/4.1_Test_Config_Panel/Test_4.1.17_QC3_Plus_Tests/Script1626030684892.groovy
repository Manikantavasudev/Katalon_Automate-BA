...
String exp_moi_name = moi_data.tc_moi_data.TC_QC3_Plus_Moi_Name

String exp_indidual_testcases_name = moi_data.tc_moi_data.QC3_Plus_Testcase_Name
...
WebUI.comment('TestcaseName:: '+'Test_4.1.1.17_QC3_Plus_Tests'+'\n')
...
'To uncheck QC3+ Tests and check the c2 testcases checkbox status'

WebUI.doubleClick(findTestObject('Object Repository/Test_Config_Panel/QC3_Plus_Tests/QC3_Plus_Moi_Checkbox'))

def moi_checkbox_sts = CustomKeywords.'grl_usb_pd_c2_Testcase.TestConfig_Page.getMoiUnSelectedStatus'(findTestObject('Object Repository/Test_Config_Panel/QC3_Plus_Tests/QC3_Plus_Moi_Checkbox'))

assert moi_checkbox_sts == true

WebUI.comment('********* Test_4.1.1.17_QC3_Plus_Tests  Execution Ended *********'+'\n')
