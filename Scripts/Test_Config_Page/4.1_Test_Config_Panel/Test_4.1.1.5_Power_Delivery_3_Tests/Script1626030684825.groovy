...
'FR Swap Auto box tooltip info'
exp_tooltip_info = fr_swap_tooltip_info


WebUI.comment('*****************************************************************************************************************************************************'+'\n')

WebUI.comment('TestcaseName:: '+'Test_4.1.1.5_Power_Delivery_3.0_Tests'+'\n')
...
WebUI.doubleClick(findTestObject('Object Repository/Test_Config_Panel/Power_Delivery_3.0_Tests/img_FR_Swap_AUTOBox_Connected_Tooltip'))
...
'STEP 7: To uncheck Power Delivery 3.0 Tests and check the c2 testcases checkbox status'
...
WebUI.comment('********* Test_4.1.1.5_Power_Delivery_3.0_Tests  Execution Ended *********'+'\n')
