...
String exp_moi_name = moi_data.tc_moi_data.TC_PD_Merged_Tests_Beta_Moi_Name

String exp_indidual_testcases_name = moi_data.tc_moi_data.PD_Merged_Testcase_Name

List exp_pd_merged_noise_type_drpdwn = moi_data.tc_moi_data.PD_Merged_Noise_Type_Drpdwn

WebUI.comment('*****************************************************************************************************************************************************'+'\n')

WebUI.comment('TestcaseName:: '+'Test_4.1.1.10_PD_Merged_Tests(Beta)'+'\n')
...
'STEP 3:To Click  TEST.PD.PHY.ALL.1 Transmit Bit Rate and the Drift Test Case'
CustomKeywords.'grl_usb_pd_c2_Testcase.TestConfig_Page.selectIndidualTestCase'(exp_moi_name, exp_indidual_testcases_name)

'STEP 4:To verify PD Merged Tests label present in right panel'
def moi_label_sts = WebUI.verifyElementVisible(findTestObject('Object Repository/Test_Config_Panel/PD_Merged_Tests_(Beta)/p_PD Merged Test Configuration'))
...
WebUI.delay(GlobalVariable.short_delay)
'noise drop down list  ejected'
//def pd_merged_noise_type_drpdwn_list = CustomKeywords.'grl_usb_pd_c2_Testcase.TestConfig_Page.getMoiConfigDropdownList'(
//    findTestObject('Object Repository/Test_Config_Panel/PD_Merged_Tests_(Beta)/button_Noise_Type_Drpdown'), '//div[@aria-labelledby="tcPdMergedNoiseTypeComboBox"]/a')

//assert exp_pd_merged_noise_type_drpdwn == pd_merged_noise_type_drpdwn_list

'STEP 6:To uncheck PD Merged Moi Tests and check the c2 testcases checkbox status'
WebUI.doubleClick(findTestObject('Object Repository/Test_Config_Panel/PD_Merged_Tests_(Beta)/PD_Merged_Moi_Checkbox'))

def moi_checkbox_sts = CustomKeywords.'grl_usb_pd_c2_Testcase.TestConfig_Page.getMoiUnSelectedStatus'(findTestObject('Object Repository/Test_Config_Panel/PD_Merged_Tests_(Beta)/PD_Merged_Moi_Checkbox'))

assert moi_checkbox_sts == true

WebUI.comment('********* Test_4.1.1.10_PD_Merged_Tests(Beta)  Execution Ended *********'+'\n')
