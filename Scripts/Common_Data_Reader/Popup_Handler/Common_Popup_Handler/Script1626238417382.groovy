...
try {
    def popup_sts = WebUI.verifyElementPresent(findTestObject('Object Repository/Browser_Main_View_Objects/Popup_Display_div'), 10)

    if (popup_sts) {
        WebUI.click(findTestObject('Browser_Main_View_Objects/Popup_Yes'))
