...
def vconn_voltage_drpdown = moi_ref.PD2_Deter_Vconn_Voltage_Drpdwn_Val

'To create Dictionary value for vconn voltage and navigate to proper xpath '
def vconn_xpath = [('_2_75V') : 1, ('_5_75V') : 2]
...
for (def vcon_voltage : vconn_xpath) {
    ...
    if (vcon_voltage.key == vconn_voltage_drpdown) {
        ...
        WebUI.click(findTestObject('Object Repository/Python_Aggregation_Moi_Objects/Cable_Dut/PD2_Deterministic_Test_Moi/dropdown/button_Vconn_Voltage'))

        WebUI.delay(GlobalVariable.short_delay)

        WebElement voltage_ele = driver.findElement(By.xpath(('(//div[@aria-labelledby="tcPd2DeterministicVconnVoltageComboBox"]/a)[' + 
                vcon_voltage.value) + ']'))
