...
def noise_type_drpdown = moi_ref.PD2_Comm_Noise_Type_Drpdwn_Val

String vconn_voltage_drpdown = moi_ref.PD2_Comm_Vconn_Voltage_Drpdwn_Val
...
WebUI.click(findTestObject('Object Repository/Python_Aggregation_Moi_Objects/Cable_Dut/PD2_Communication_Engine_Tests_Moi/dropdown/button_Noise_Type'))

WebUI.delay(GlobalVariable.short_delay)

driver.findElement(By.xpath(('//a[text()=\'' + noise_type_drpdown) + '\']')).click()
...
for (def vcon_voltage : vconn_xpath) {
    if (vcon_voltage.key == vconn_voltage_drpdown) {
        ...
        WebUI.click(findTestObject('Object Repository/Python_Aggregation_Moi_Objects/Cable_Dut/PD2_Communication_Engine_Tests_Moi/dropdown/button_Vconn_Voltage'))

        WebUI.delay(GlobalVariable.short_delay)

        WebElement voltage_ele = driver.findElement(By.xpath(('(//div[@aria-labelledby="tcPd2CommunicationVconnVlotageComboBox"]/a)[' + 
                vcon_voltage.value) + ']'))
