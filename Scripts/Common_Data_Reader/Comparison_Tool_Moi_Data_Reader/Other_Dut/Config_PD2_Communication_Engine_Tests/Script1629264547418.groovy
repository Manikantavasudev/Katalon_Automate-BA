...
def noise_type_drpdwn = moi_ref.PD2_Comm_Noise_Type_Drpdwn_Val
...
'To select noise type dropdown value'
WebUI.click(findTestObject('Python_Aggregation_Moi_Objects/Config_PD2_Communication_Tests_Moi/dropdown/button_Noise_Type'))

WebUI.delay(GlobalVariable.short_delay)

driver.findElement(By.xpath(('//a[text()=\'' + noise_type_drpdwn) + '\']')).click()
