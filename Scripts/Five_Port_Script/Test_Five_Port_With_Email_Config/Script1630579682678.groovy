...
def send_auto_email = [python_path, "$email_config_py_path", summary_report_folder, "$email_config_json_path", exe_timestamp
	, stop_exe_timestamp, c2_app_version, katalon_build_version].execute()
