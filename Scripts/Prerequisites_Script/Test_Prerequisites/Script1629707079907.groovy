...
'To open browser Application if it is closed'

String prereq_path = Installation_path + '\\Dut_Testing_Data_Config\\PyFiles\\Prerequisites.py'

def task_new = [python_path, "$prereq_path"].execute()
