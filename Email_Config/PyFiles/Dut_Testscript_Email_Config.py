...
class Auto_Email_Configuration:
    def __init__(self,json_filename,test_start_time,test_stop_time,td_mins,c2_app_version,katalon_build_version):
    ...
    def set_email_configuration(self):
        subject = "Automated Mail: C2 Katalon Automation Dut Testing Report"
        body = " {}\n\n  {}\n\n Test Start Time: {}\n Test End Time: {}\n C2 Application Version: {}\n C2 Katalon Build Version: {}\n {}\n\n {}\n {}\n\n".format(
            "Hello Team,",
            "This is an Auto generated mail regarded C2 Automation testing",
            self.testexe_start_time,
            self.testexe_stop_time,
            self.c2_app_ver,
            self.katalon_build_ver,
            "Attached Files : Golden file Compare Tool Summary reports",
            "Regards",
            "C2 Automation Team"
            )
        html = """\
            ...
            <td >Golden file Compare Tool Summary reports</td>
            </tr>
            </table>
            <p>Regards,<br>
...
def main():  
    ...
    test_start_time = sys.argv[2]
    test_stop_time = sys.argv[3]
    c2_app_version = sys.argv[4]
    katalon_build_version = sys.argv[5]
    ...
    mail_config_obj = Auto_Email_Configuration(general_config_json_path,test_start_time,test_stop_time,td_mins,c2_app_version,katalon_build_version)
