...
class Specific {
	...
	def forDRPMOISelection () {
		...
		try {
			...
			WebUI.click(findTestObject('Object Repository/FRS_PDM/FRS_SRC'))
			WebUI.click(findTestObject('Object Repository/FRS_PDM/FRS_SNK'))
			//	}
		}
		catch(Exception e) {
	...
	def ProviderOnly () {
		...
		//WebUI.click(findTestObject('Object Repository/MOI_selection_lists/MFI/MFI_4_9_2'))
	}
	//	def ProviderOnly ()
	//	{
	//		WebUI.click(findTestObject('Object Repository/SRC_3_issue/src_2'))
	//		WebUI.click(findTestObject('Object Repository/SRC_3_issue/SRC-3'))
	//		WebUI.click(findTestObject('Object Repository/SRC_3_issue/SNK_1'))
	//	}
